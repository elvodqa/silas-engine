...
pub fn sub_vec2(v0: Vec2, v1: Vec2) -> Vec2 {
    vec2(v0.x - v1.x, v0.y - v1.y)
}

pub fn dot_vec2(v0: Vec2, v1: Vec2) -> f32 {
    v0.x * v1.x + v0.y * v1.y
}
...
pub fn sub_vec4(v0: Vec4, v1: Vec4) -> Vec4 {
    vec4(v0.x - v1.x, v0.y - v1.y, v0.z - v1.z, v0.w - v1.w)
}

pub fn dot_vec4(v0: Vec4, v1: Vec4) -> f32 {
    v0.x * v1.x + v0.y * v1.y + v0.z * v1.z + v0.w * v1.w
}

pub fn norm_vec4(v: Vec4) -> Vec4 {
    let l = len_vec4(v);
...
#[inline]
pub fn len_vec4(v: Vec4) -> f32 {
    dot_vec4(v, v).sqrt()
}

pub fn cross_vec4(v0: Vec4, v1: Vec4) -> Vec4 {
    vec4(
        (v0.y * v1.z) - (v0.z * v1.y),
        (v0.z * v1.x) - (v0.x * v1.z),
        (v0.x * v1.y) - (v0.y * v1.x),
